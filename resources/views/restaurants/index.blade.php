          ...
          @foreach ($data as $key => $value)
                ...
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-10 w-10">
                    <img   class="h-10 w-10 " src="{{ asset('storage/restaurants/'.$value->file_path) }}"  alt="">
                  </div>
                  <div class="ml-4">
              ...
              <form action="{{ route('restaurants.destroy',$value->id) }}" method="POST">   
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="{{ route('restaurants.edit',$value->id) }}"class="text-indigo-600 hover:text-indigo-900">Modifier</a>
